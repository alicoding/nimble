(function(global, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['EventEmitter', 'cookie', 'analytics'], factory);
  }
  // Expose a global instead
  else {
    global.Localized = factory(window.EventEmitter, window.cookiejs, window.analytics);
  }
}(this, function(EventEmitter, cookiejs, analytics) {
